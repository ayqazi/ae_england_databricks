...
# MAGIC %md
# MAGIC 
# MAGIC # A&E Attendences in England - Extract & Load
# MAGIC 
...
en_bronze_csv = spark.read.format("csv").option("header", True).load(sources_path + "/AE_attendances_england_monthly.csv")
display(en_bronze_csv)

# COMMAND ----------

save_path = f"{tables_path}/en_bronze.delta"
